...
class ConnectBooksAndReviews extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        # Remove the field associated with the old way we were storing authors
            ...
            $table->bigInteger('drama_id')->unsigned()->nullable();

            # This field `author_id` is a foreign key that connects to the `id` field in the `authors` table
            $table->foreign('drama_id')->references('id')->on('reviews');
        });
    }
    ...
    public function down()
    {
        ...
        # ref: http://laravel.com/docs/migrations#dropping-indexes
            ...
            $table->dropForeign('reviews_drama_id_foreign');

            $table->dropColumn('drama_id');
        });
    }
}
